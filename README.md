...
## Equal Coins Problem Code: EQUALCOIN Solved Submit
Read problem statements in Bengali and Russian.
Chef has X
 coins worth 1
 rupee each and Y
 coins worth 2
 rupees each. He wants to distribute all of these X+Y
 coins to his two sons so that the total value of coins received by each of them is the same. Find out whether Chef will be able to do so.
